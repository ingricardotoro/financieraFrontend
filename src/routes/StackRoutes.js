...
import SubirPagos from '../page/Loans/SubirPagos';
  ...
  return (
    <>
      <Switch>
        <Route
          exact
          path="/clientes/expediente/:idcustomer"
        ...
        <Route
          exact
          path="/avales/expediente/:idaval"
          component={AvalRecordsPage}
        />
        ...
        <Route
          exact
          path="/prestamos/ver/:idloan/:idrequest"
          component={ViewLoanPage}
        />
        <Route exact path="/prestamos" component={ListLoansPage} />
        <Route exact path="/prestamos/subirpagos" component={SubirPagos} />
