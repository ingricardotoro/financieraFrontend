...
import DataAval from '../../components/avales/DataAval';
...
export default function SimpleTabs(props) {
  ...
  let idAval = props.match.params.idaval
    ...
    <div className="pcoded-inner-content">
        ...
        <div className="main-body">
            ...
            <div className="page-header mt-5">
                ...
                <h4>Expediente del Aval</h4>
                <span>Módulo para gestionar los datos de cada aval</span>
                </div>
                ...
                <ul className="breadcrumb-title">
                    ...
                    <li className="breadcrumb-item"><Link to="/avales"> Volver a Avales</Link>
                    </li>
