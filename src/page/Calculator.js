...
export const Calculator = () => {
  ...
  const ValidarCampos = () => {
    ...
    if (amount === 0 || amount === '') {
      ...
      (quotaValue === 0 || quotaValue === '' || parseFloat(quotaValue) < 100) &&
      (quota === 0 || quota === '')
    ) {
      setError(true);
      setdescargar(false);
  ...
  const CalcularCutoasInteresCompuesto = () => {
    ...
    if (TipoCalculo === 'NumeroDeCuotas') {
      ...
      setData({
        ...
        totalAmount: (
          parseFloat(amount) +
          parseFloat(SumadeInteres) +
          Close
        ).toFixed(2),
        quotaValue: (
          (parseFloat(amount) + parseFloat(SumadeInteres) + Close) /
          quota
        ).toFixed(2),
      });
      ...
      while (SaldoFinal > 0) {
        ...
        for (let i = 0; i < contador; i++) {
          ...
          console.table(
            ...
            InteresSemanal.toFixed(2),
            quotaValue,
            AbonoCapital.toFixed(2),
  ...
  const generarPDF = async () => {
    Axios.post(URL_API + '/reports/reportCalculator', data)
      ...
      .then(() =>
        Axios.get(URL_API + '/reports/fetchReportCalculator', {
          responseType: 'blob',
        })
      )
      .then((res) => {
              ...
              <div className="card">
                <div className="card-header">
                  <div className="row">
                    <div className="col-sm-12 col-md-3">
                      ...
                      <div className="input-group">
                        <p className="input-group-addon" id="basic-addon1">
                        ...
                        >
                          <option selected value="Solidario">
                            Solidario
                          </option>
                    ...
                    <div className="col-sm-12 col-md-2">
                      ...
                      <div className="input-group">
                        <p className="input-group-addon" id="basic-addon1">
                          <i className="icofont icofont-hour-glass"></i>
                        </p>
                        <select
                    ...
                    <div className="col-sm-12 col-md-2">
                      ...
                      <div className="input-group">
                        ...
                        <input
                          ...
                          type="number"
                          className="form-control"
                          placeholder="Tasa de Interes en %"
                        />
                      </div>
                    </div>
                    ...
                    <div className="col-sm-12 col-md-2">
                      ...
                      <div className="input-group">
                        ...
                        <select
                          ...
                          className="form-control col-md-12"
                        >
                          <option selected value="Compuesto">
                            Compuesto
                          </option>
                    ...
                    <div className="col-sm-12 col-md-3">
                      ...
                      <div className="input-group">
                        ...
                        <input
                          ...
                          min="0"
                          className="form-control"
                          placeholder="Valor de Cada Couta"
                        />
                      </div>
                    </div>
                  ...
                  <div className="row">
                      ...
                      <div className="input-group">
                        ...
                        {descargar === true ? (
                          <button
                            onClick={() => generarPDF()}
                            id="btnDescargar"
                            className="btn btn-primary width-20"
                          >
                    ...
                    <div className="col-sm-12 col-md-3">
                      ...
                      <div className="input-group">
                        ...
                        <input
                          disabled
                          value={closingCostVar}
                          className="form-control"
                          name="closingCost"
                          id="closingCost"
                          type="text"
                          placeholder="Costo de Cierre 4%"
                        />
                      </div>
                    </div>
                  ...
                  <div className="table-responsive">
                    ...
                    {tablaAmortizacionVC === true &&
                      Error === false &&
                      parseFloat(quotaValue) > 100 && (
                        <TablaAmortizacionVC
                          CapitalInicial={amount}
                          Tasa={rate}
                          TipoTasa={tipotasa}
