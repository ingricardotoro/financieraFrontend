...
function DataCustomer({idCustomer}) {
    ...
    const getCustomerById = async(id)=>{
        ...
        let fec = new Date(resp_customer.data.customer.personId.fec_nac)
                ...
                <div className="row">
                    ...
                    <div className="col-sm-12 col-md-6">
                        <div className="input-group">
                            ...
                            <input value="2020-02-02"  onChange={handleInputChange}  name="fec_nac" id="fec_nac" className="form-control" type="date"/>
                        </div>
                    </div>
