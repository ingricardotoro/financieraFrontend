...
function DataCustomer({ idCustomer }) {
  ...
  const getCustomerById = async (id) => {
    const resp_customer = await Axios.post(
      URL_API + '/customers/findCustomerById/' + id
    );
    ...
    <div>
        ...
        <div className="col-sm-6 col-md-6">
          ...
          {flatEdit === true ? (
            <button
              ...
              className=" btn btn-success btn-round f-right d-inline-flex "
            >
              {<SaveIcon />}
              Guardar
            </button>
            ...
            <button
              ...
              className=" btn btn-warning btn-round f-right d-inline-flex "
            >
              {<EditIcon />}
              Editar Cliente
            </button>
          ...
          {flatEdit === true ? (
            <button
              ...
              className=" btn btn-danger btn-round  f-right d-inline-flex "
            >
              {<CancelIcon />}
              Cancel
            </button>
        ...
        <div className="col-sm-12 col-md-6">
          <div className="input-group">
            ...
            <input
              ...
              type="text"
              className="form-control"
              placeholder="Apellidos de Clientes"
            />
          </div>
        </div>
      </div>
      ...
      <div className="row">
        ...
        <div className="col-sm-12 col-md-6">
          <div className="input-group">
            <span className="input-group-addon" id="basic-addon1">
              <i className="icofont icofont-ui-calendar mr-1"></i> Nacimiento
            </span>
            <input
              disabled={!flatEdit}
              value={fec_nac}
              onChange={(e) => {
                setFec_nac(e.target.value);
              }}
              name="fec_nac"
              id="fec_nac"
              className="form-control"
      ...
      <div className="row">
        ...
        <div className="col-sm-12 col-md-3">
          <div className="input-group">
            <span className="input-group-addon" id="basic-addon1">
              <i className="icofont icofont-fix-tools "></i>
            </span>
            <input
              disabled={!flatEdit}
              value={profesion}
        ...
        <div className="col-sm-12 col-md-6">
          <div className="input-group">
            <span className="input-group-addon" id="basic-addon1">
              <i className="icofont icofont-paper-clip mr-1"></i>Fotografia{' '}
            </span>
            <input
              disabled={!flatEdit}
              accept="image/*"
